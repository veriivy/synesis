// GENERATED by scripts/build-fixtures.mjs from /fixtures/stream.jsonl. Do not edit.
// 25 events, happy path, in order.
...
export const fixtureStream: SSEEvent[] = [
  ...
  },
  {
    ...
    "room_id": "room_demo01",
    "round": 1,
    "content": "d1 is two musts. Can authenticate_user accept both? d2: name a single owner for middleware.py.",
  ...
  },
  {
    ...
    "plan": {
      ...
      "resolutions": [
        ...
        {
          "issue_id": "d2",
          "outcome": "a1 owns middleware.py.",
          "rationale": "One writer per path."
        },
        {
          "issue_id": "d3",
  ...
  },
  {
    ...
    "room_id": "room_demo01",
    "plan_id": "plan_demo01",
    "ts": "2026-09-12T03:02:20.000Z"
  },
  {
    "type": "context_updated",
    "room_id": "room_demo01",
    "version": 2,
    "content": "authenticate_user accepts a session cookie or a Bearer JWT. a1 owns session.py and middleware.py. a2 owns jwt.py, app.py, tests/test_auth.py.",
  ...
  },
  {
    ...
    "accepted": false,
    "reason": "path_not_owned: src/auth/middleware.py belongs to ticket t3 (owner a1). Agent a2 owns: src/auth/jwt.py.",
