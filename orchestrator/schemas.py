...
Only FinalPlan/Ticket (and what they're built from) are used as typed
models elsewhere in this package — negotiate's PoAs and K2's analysis stay
as plain dicts (see k2.py, agents.py), matching how the rest of the
orchestrator already works. These types exist for validator.py and
ticketing.py, where getting the shape wrong is exactly the kind of bug
that shouldn't be caught by hand.
"""
